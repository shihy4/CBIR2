...
public class CBIR extends JFrame {
    ...
    private final int[] buttonOrder; //creates array to keep up the image order 
    ...
    private void initComponents() {
        ...
        panelLeft.setBorder(javax.swing.BorderFactory.
        		createTitledBorder(null, "Gallery - Please Select an Image", 
        ...
        photographLabel.setFont(new java.awt.Font("Lucida Grande", 1, 14)); 
        photographLabel.setForeground(new java.awt.Color(102, 102, 102));
        photographLabel.setHorizontalAlignment(
        		javax.swing.SwingConstants.CENTER);
        photographLabel.setIcon(new javax.swing.ImageIcon(
        		getClass().getResource("logo/not-selected.png"))); // NOI18N
        photographLabel.setBorder(
        		javax.swing.BorderFactory.createTitledBorder(null, "Photo", 
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, 
                javax.swing.border.TitledBorder.DEFAULT_POSITION, 
                new java.awt.Font("Lucida Grande", 1, 14), 
                new java.awt.Color(102, 102, 102))); // NOI18N
        photographLabel.setHorizontalTextPosition(
        		javax.swing.SwingConstants.CENTER);
        photographLabel.setSize(new java.awt.Dimension(400, 300));
        photographLabel.setVerticalTextPosition(
        ...
        logoLable.setIcon(new javax.swing.ImageIcon(
        		getClass().getResource("logo/logo2.png")));
        ...
        selectAll.setToolTipText(
        		"Intensity + Color Code with Relevance Feedback");
        ...
        fileJMenu.setToolTipText(
        		"Clear selected, Print selected, or Exit program");
  ...
  //GEN-FIRST:event_printJMenuItemActionPerformed
    ...
    //GEN-FIRST:event_exitJMenuItemActionPerformed
    private void exitJMenuItemActionPerformed(java.awt.event.ActionEvent evt) {
        System.exit(0);
    }//GEN-LAST:event_exitJMenuItemActionPerformed

    //GEN-FIRST:event_aboutJMenuItemActionPerformed
    private void aboutJMenuItemActionPerformed(java.awt.event.ActionEvent evt) {
        About aboutPage = new About();
        aboutPage.setVisible(true);
    }//GEN-LAST:event_aboutJMenuItemActionPerformed

    //GEN-FIRST:event_resetJMenuItemActionPerformed
    private void resetJMenuItemActionPerformed(java.awt.event.ActionEvent evt) {
        resetButtonClicked();
    ...
    public CBIR() {
        ...
        if(intenityFileFailed || colorCodeFileFailed || normalizedFileFailed) {
            ...
            normalizedFileFailed = readNormalizedFile();
        }
        if(!(intenityFileFailed || colorCodeFileFailed || 
        		normalizedFileFailed)) {
        	setImageSizes();
            displayPage();
        }
    ...
    /**************************************************************************
     * putButtonAndCheckboxIntoHolder - Puts button and checkbox in holder
     * @param imageButNo the current image button and checkbox number
     *************************************************************************/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            (CBIR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
